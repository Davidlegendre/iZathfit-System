...
GO
ALTER TABLE [dbo].[Persona] DROP CONSTRAINT [FK__Persona__idGener__06CD04F7];
...
GO
ALTER TABLE [dbo].[Persona] DROP CONSTRAINT [FK__Persona__idtipoI__07C12930];
...
GO
ALTER TABLE [dbo].[Persona] DROP CONSTRAINT [FK__Persona__idRol__08B54D69];
...
GO
ALTER TABLE [dbo].[Contrato] DROP CONSTRAINT [FK__Contrato__IdPers__02FC7413];
...
GO
ALTER TABLE [dbo].[NumEmergencias] DROP CONSTRAINT [FK__NumEmerge__IdPer__03F0984C];
...
GO
ALTER TABLE [dbo].[OcupacionXPersona] DROP CONSTRAINT [FK__Ocupacion__IdPer__04E4BC85];
...
GO
ALTER TABLE [dbo].[PadecimientoEnfermedades] DROP CONSTRAINT [FK__Padecimie__IdPer__05D8E0BE];
...
GO
ALTER TABLE [dbo].[Usuario] DROP CONSTRAINT [FK__Usuario__IdPerso__09A971A2];
