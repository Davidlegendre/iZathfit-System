...
GO
ALTER TABLE [dbo].[Contrato] DROP CONSTRAINT [FK__Contrato__IdPers__52593CB8];
...
GO
ALTER TABLE [dbo].[NumEmergencias] DROP CONSTRAINT [FK__NumEmerge__IdPer__5535A963];
...
GO
ALTER TABLE [dbo].[OcupacionXPersona] DROP CONSTRAINT [FK__Ocupacion__IdPer__5629CD9C];
...
GO
ALTER TABLE [dbo].[PadecimientoEnfermedades] DROP CONSTRAINT [FK__Padecimie__IdPer__5812160E];
...
GO
ALTER TABLE [dbo].[Persona] DROP CONSTRAINT [FK__Persona__idGener__5AEE82B9];
...
GO
ALTER TABLE [dbo].[Persona] DROP CONSTRAINT [FK__Persona__idtipoI__5BE2A6F2];
...
GO
ALTER TABLE [dbo].[Persona] DROP CONSTRAINT [FK__Persona__idRol__5CD6CB2B];
...
GO
ALTER TABLE [dbo].[Usuario] DROP CONSTRAINT [FK__Usuario__IdPerso__66603565];
...
GO
PRINT N'Modificando Procedimiento [dbo].[SelectAllGenero]...';


GO
ALTER procedure SelectAllGenero
	as
	BEGIN 
		select IdGenero, descripcion, code from Genero
		exec dbo.SelectAllRol
	END
GO
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Contrato'), OBJECT_ID(N'dbo.NumEmergencias'), OBJECT_ID(N'dbo.OcupacionXPersona'), OBJECT_ID(N'dbo.PadecimientoEnfermedades'), OBJECT_ID(N'dbo.Persona'), OBJECT_ID(N'dbo.Usuario'))
               AND [type] IN (N'F', N'C')
