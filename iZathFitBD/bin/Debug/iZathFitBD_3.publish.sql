...
GO
ALTER TABLE [dbo].[Persona] DROP CONSTRAINT [FK__Persona__idGener__123EB7A3];
...
GO
ALTER TABLE [dbo].[Persona] DROP CONSTRAINT [FK__Persona__idtipoI__1332DBDC];
...
GO
ALTER TABLE [dbo].[Persona] DROP CONSTRAINT [FK__Persona__idRol__14270015];
...
GO
ALTER TABLE [dbo].[Contrato] DROP CONSTRAINT [FK__Contrato__IdPers__0E6E26BF];
...
GO
ALTER TABLE [dbo].[NumEmergencias] DROP CONSTRAINT [FK__NumEmerge__IdPer__0F624AF8];
...
GO
ALTER TABLE [dbo].[OcupacionXPersona] DROP CONSTRAINT [FK__Ocupacion__IdPer__10566F31];
...
GO
ALTER TABLE [dbo].[PadecimientoEnfermedades] DROP CONSTRAINT [FK__Padecimie__IdPer__114A936A];
...
GO
ALTER TABLE [dbo].[Usuario] DROP CONSTRAINT [FK__Usuario__IdPerso__151B244E];
